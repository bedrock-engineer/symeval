...
Head to the [Getting started](getting-started.qmd) tutorial for a reactive walkthrough and more advanced SymEval functionality, or read [how SymEval works](explanation.qmd) for the ideas behind SymEval.
