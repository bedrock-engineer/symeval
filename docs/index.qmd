---
title: SymEval
subtitle: "Symbolic, unit-aware evaluation of SymPy equations."
toc: false
---
...
SymEval integrates seamlessly with [marimo](https://docs.marimo.io "marimo docs") and [Quarto](https://quarto.org "Quarto docs"), such that you can make [explorable explanations ](https://worrydream.com/ExplorableExplanations "Explorable explanations by Bret Victor")in Python notebooks or websites, and automate calculation report generation.
...
v &= 37.6\times 10^{3}\ \frac{\mathrm{m}}{\mathrm{h}} = 37.6\ \frac{\mathrm{km}}{\mathrm{h}}
\end{align*}$$

Head to the [Getting started](getting-started.qmd) tutorial for a live, interactive walkthrough and more advanced SymEval functionality, or read [how SymEval works](explanation.qmd) for the ideas behind SymEval.
